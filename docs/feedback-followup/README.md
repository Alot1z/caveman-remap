...
|---|---|---|---|---|
| #936 | Firefox port | 3 required fixes; applied by maintainer post-merge with follow-up notes | MERGED; follow-ups recorded | [PR-936](PR-936-firefox-port.md) |
...
| #955 | test-count gate | shape no-ops (per-branch map); counting bug; dead weight; template checkbox suggested | CLOSED; cheaper alternative given | [PR-955](PR-955-test-count-gate.md) |
